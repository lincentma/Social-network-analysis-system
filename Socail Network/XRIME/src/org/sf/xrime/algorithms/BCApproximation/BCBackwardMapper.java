...
/**
 * @author Yang Cheng
 * do nothing ,just emit the vertexes
 */
public class BCBackwardMapper extends GraphAlgorithmMapReduceBase implements Mapper<Text, LabeledAdjBiSetVertex, Text, LabeledAdjBiSetVertex> {
  @Override
  public void map(Text key, LabeledAdjBiSetVertex value,
      ...
      throws IOException {
//    System.out.println("Here Backward Mapper ---------------------===============");
